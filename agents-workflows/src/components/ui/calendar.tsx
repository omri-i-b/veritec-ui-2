...
const DEFAULT_START_MONTH = new Date(1950, 0)
const DEFAULT_END_MONTH = new Date(new Date().getFullYear() + 5, 11)
...
function CalendarDropdown({ options, value, onChange }: DropdownProps) {
  ...
  return (
    <Select value={String(value ?? "")} onValueChange={handleValueChange}>
      <SelectTrigger
        size="sm"
        className="h-7 border-transparent bg-transparent px-2 py-0 text-sm font-medium shadow-none hover:bg-accent focus-visible:ring-0"
      >
