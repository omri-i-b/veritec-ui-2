...
const cardVariants = cva(
  "group/card flex flex-col overflow-hidden text-sm text-card-foreground",
  {
    variants: {
      variant: {
        default:
          "gap-6 rounded-2xl bg-card py-6 ring-1 ring-foreground/10 has-[>img:first-child]:pt-0 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl",
        page: "h-full gap-6 rounded-xl border border-border bg-card pt-4 px-4",
      },
    },
    defaultVariants: {
      variant: "default",
