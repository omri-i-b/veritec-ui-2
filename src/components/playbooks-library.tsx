...
const PLAYBOOKS: Playbook[] = [
  ...
  },
  {
    ...
    description: "Triggered when a Filevine project moves into 'Records pending' phase — drafts a HIPAA-compliant records request letter for each treating provider.",
    category: "Pre-litigation",
    icon: Notepad,
    iconColor: "text-blue-800",
    iconBg: "bg-blue-50",
