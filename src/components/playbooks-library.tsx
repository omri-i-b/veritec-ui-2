...
const PLAYBOOKS: Playbook[] = [
  ...
  },
  {
    ...
    description: "AI Deposition Question Engine — classifies the deponent, extracts facts, finds contradictions and gaps, generates questions with reasoning, applies KB standards, and sequences the exam.",
    category: "Litigation",
    icon: Notepad,
    ...
    runs: 324,
    lastRun: "2m ago",
    creator: { name: "Vanessa Kim", initials: "VK", color: "bg-rose-100 text-rose-700" },
    pinned: true,
    trending: true,
  },
  {
    ...
    description: "Turn a completed deposition transcript into an interactive Q&A table with exhibit links, page references, and auto-indexing.",
    category: "Litigation",
    icon: FileText,
  ...
  },
  {
    ...
    description: "Auto-organizes deposition documents into standard bookmark categories (Notice, Transcript, Errata, Exhibits) grouped by deponent.",
    category: "Litigation",
    icon: FileText,
    iconColor: "text-purple-700",
    iconBg: "bg-purple-50",
  ...
  },
  {
    ...
    description: "End-to-end weekly status memo. Pulls case file + recent activity, identifies what changed, drafts a posture memo ready to save into the case or paste elsewhere.",
    category: "Litigation",
    icon: Notepad,
    iconColor: "text-emerald-700",
    iconBg: "bg-emerald-50",
  ...
  },
  {
    ...
    description: "User-run voice playbook that calls a web-form lead. Qualifies the matter, captures basics, and books a consult — or hands off to a human if it goes off-script.",
    category: "Intake",
    icon: PhoneCall,
    iconColor: "text-blue-800",
    iconBg: "bg-blue-50",
    ...
    runs: 1284,
    lastRun: "11m ago",
    creator: { name: "Pierce Skribonic", initials: "PS", color: "bg-violet-100 text-violet-700" },
    pinned: true,
    trending: true,
  },
]
