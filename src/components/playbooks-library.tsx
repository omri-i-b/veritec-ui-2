...
const PLAYBOOKS: Playbook[] = [
  ...
  },
  {
    ...
    description: "Analyzes case data to find weaknesses and generates targeted deposition questions with document citations, using prior depositions as tone reference.",
    category: "Litigation",
    icon: Notepad,
