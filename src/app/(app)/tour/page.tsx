...
const SECTIONS: { title: string; subtitle: string; tiles: Tile[] }[] = [
  ...
  },
  {
    title: "Voice",
    subtitle:
      "Voice agents are playbooks with a Voice step. Configure first; operate second.",
    tiles: [
      {
        title: "Intake Callback (Voice)",
        blurb:
          "Single-step voice agent: dials a web-form lead, runs goals, extracts structured fields.",
        href: "/playbooks/intake-callback-voice/edit",
        icon: PhoneCall,
        iconBg: "bg-blue-50",
        iconColor: "text-blue-800",
        bullets: [
          "One Voice step with persona, goals, and call configuration",
          "Returns are typed — Caller name, Matter type, Incident date, Outcome, etc.",
          "Same canvas + memory model as document playbooks",
        ],
        tags: [{ label: "Retell-style prompt", tone: "violet" }],
      },
      {
        title: "Medical Treatment Verification",
        blurb:
          "Cadence-driven check-in call. Loads prior treatment record into memory, then dials.",
        href: "/playbooks/med-treatment-verification-voice/edit",
        icon: PhoneCall,
        iconBg: "bg-green-50",
        iconColor: "text-green-700",
        bullets: [
          "Fetch step writes prior record to memory; Voice step reads it",
          "Auto-detects English / Spanish",
          "Flags treatment gaps before they hurt the case",
        ],
      },
      {
        title: "Operator surfaces",
        blurb:
          "Where voice runs are reviewed: inbox, live inbound queue, outbound pipeline.",
        href: "/voice",
        icon: PhoneIncoming,
        iconBg: "bg-purple-50",
        iconColor: "text-purple-700",
        bullets: [
          "Inbox: Needs review default with escalated bumped",
          "Inbound (live): take-over / listen / escalate",
          "Outbound pipeline: pending / in-flight / recent with countdowns",
          "Call detail: transcript \u2194 fields coupling, sticky player",
        ],
